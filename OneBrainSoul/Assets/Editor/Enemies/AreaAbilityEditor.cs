    ...
    public class AreaAbilityEditor : MyEditor
    {
        ...
        private void AbilityCast(AreaAbilityProperties areaAbilityProperties)
        {
            ...
            if (isAbilityCastFoldoutOpen)
            {
                ...
                FloatField(ref areaAbilityProperties.abilityCast.animationExtraTime, 0, "Animation Extra Time");
            ...
            AbilityMovement(ref areaAbilityProperties.abilityMovement, areaAbilityProperties.abilityAoE.duration);
